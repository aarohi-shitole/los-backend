...
class NomineeResourceIT {
    ...
    private static final Double DEFAULT_NOMINEE_PERCENTAGE = 1D;
    private static final Double UPDATED_NOMINEE_PERCENTAGE = 2D;
    private static final Double SMALLER_NOMINEE_PERCENTAGE = 1D - 1D;
    ...
    void createNominee() throws Exception {
        ...
        assertThat(testNominee.getIsActive()).isEqualTo(DEFAULT_IS_ACTIVE);
        assertThat(testNominee.getIsDeleted()).isEqualTo(DEFAULT_IS_DELETED);
        assertThat(testNominee.getFreeField1()).isEqualTo(DEFAULT_FREE_FIELD_1);
        assertThat(testNominee.getFreeField2()).isEqualTo(DEFAULT_FREE_FIELD_2);
        assertThat(testNominee.getFreeField3()).isEqualTo(DEFAULT_FREE_FIELD_3);
        assertThat(testNominee.getFreeField4()).isEqualTo(DEFAULT_FREE_FIELD_4);
    }
    ...
    void getAllNominees() throws Exception {
        ...
        restNomineeMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomineePercentage").value(hasItem(DEFAULT_NOMINEE_PERCENTAGE.doubleValue())))
    ...
    void getNominee() throws Exception {
        ...
        restNomineeMockMvc
            ...
            .andExpect(jsonPath("$.nomineePercentage").value(DEFAULT_NOMINEE_PERCENTAGE.doubleValue()))
    ...
    @Test
    @Transactional
    void getAllNomineesByIsActiveIsEqualToSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where isActive equals to DEFAULT_IS_ACTIVE
        defaultNomineeShouldBeFound("isActive.equals=" + DEFAULT_IS_ACTIVE);

        // Get all the nomineeList where isActive equals to UPDATED_IS_ACTIVE
        defaultNomineeShouldNotBeFound("isActive.equals=" + UPDATED_IS_ACTIVE);
    }

    @Test
    @Transactional
    void getAllNomineesByIsActiveIsInShouldWork() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where isActive in DEFAULT_IS_ACTIVE or UPDATED_IS_ACTIVE
        defaultNomineeShouldBeFound("isActive.in=" + DEFAULT_IS_ACTIVE + "," + UPDATED_IS_ACTIVE);

        // Get all the nomineeList where isActive equals to UPDATED_IS_ACTIVE
        defaultNomineeShouldNotBeFound("isActive.in=" + UPDATED_IS_ACTIVE);
    }

    @Test
    @Transactional
    void getAllNomineesByIsActiveIsNullOrNotNull() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where isActive is not null
        defaultNomineeShouldBeFound("isActive.specified=true");

        // Get all the nomineeList where isActive is null
        defaultNomineeShouldNotBeFound("isActive.specified=false");
    }
    ...
    @Test
    @Transactional
    void getAllNomineesByFreeField1IsEqualToSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField1 equals to DEFAULT_FREE_FIELD_1
        defaultNomineeShouldBeFound("freeField1.equals=" + DEFAULT_FREE_FIELD_1);

        // Get all the nomineeList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultNomineeShouldNotBeFound("freeField1.equals=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField1IsInShouldWork() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField1 in DEFAULT_FREE_FIELD_1 or UPDATED_FREE_FIELD_1
        defaultNomineeShouldBeFound("freeField1.in=" + DEFAULT_FREE_FIELD_1 + "," + UPDATED_FREE_FIELD_1);

        // Get all the nomineeList where freeField1 equals to UPDATED_FREE_FIELD_1
        defaultNomineeShouldNotBeFound("freeField1.in=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField1IsNullOrNotNull() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField1 is not null
        defaultNomineeShouldBeFound("freeField1.specified=true");

        // Get all the nomineeList where freeField1 is null
        defaultNomineeShouldNotBeFound("freeField1.specified=false");
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField1ContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField1 contains DEFAULT_FREE_FIELD_1
        defaultNomineeShouldBeFound("freeField1.contains=" + DEFAULT_FREE_FIELD_1);

        // Get all the nomineeList where freeField1 contains UPDATED_FREE_FIELD_1
        defaultNomineeShouldNotBeFound("freeField1.contains=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField1NotContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField1 does not contain DEFAULT_FREE_FIELD_1
        defaultNomineeShouldNotBeFound("freeField1.doesNotContain=" + DEFAULT_FREE_FIELD_1);

        // Get all the nomineeList where freeField1 does not contain UPDATED_FREE_FIELD_1
        defaultNomineeShouldBeFound("freeField1.doesNotContain=" + UPDATED_FREE_FIELD_1);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField2IsEqualToSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField2 equals to DEFAULT_FREE_FIELD_2
        defaultNomineeShouldBeFound("freeField2.equals=" + DEFAULT_FREE_FIELD_2);

        // Get all the nomineeList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultNomineeShouldNotBeFound("freeField2.equals=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField2IsInShouldWork() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField2 in DEFAULT_FREE_FIELD_2 or UPDATED_FREE_FIELD_2
        defaultNomineeShouldBeFound("freeField2.in=" + DEFAULT_FREE_FIELD_2 + "," + UPDATED_FREE_FIELD_2);

        // Get all the nomineeList where freeField2 equals to UPDATED_FREE_FIELD_2
        defaultNomineeShouldNotBeFound("freeField2.in=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField2IsNullOrNotNull() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField2 is not null
        defaultNomineeShouldBeFound("freeField2.specified=true");

        // Get all the nomineeList where freeField2 is null
        defaultNomineeShouldNotBeFound("freeField2.specified=false");
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField2ContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField2 contains DEFAULT_FREE_FIELD_2
        defaultNomineeShouldBeFound("freeField2.contains=" + DEFAULT_FREE_FIELD_2);

        // Get all the nomineeList where freeField2 contains UPDATED_FREE_FIELD_2
        defaultNomineeShouldNotBeFound("freeField2.contains=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField2NotContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField2 does not contain DEFAULT_FREE_FIELD_2
        defaultNomineeShouldNotBeFound("freeField2.doesNotContain=" + DEFAULT_FREE_FIELD_2);

        // Get all the nomineeList where freeField2 does not contain UPDATED_FREE_FIELD_2
        defaultNomineeShouldBeFound("freeField2.doesNotContain=" + UPDATED_FREE_FIELD_2);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField3IsEqualToSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField3 equals to DEFAULT_FREE_FIELD_3
        defaultNomineeShouldBeFound("freeField3.equals=" + DEFAULT_FREE_FIELD_3);

        // Get all the nomineeList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultNomineeShouldNotBeFound("freeField3.equals=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField3IsInShouldWork() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField3 in DEFAULT_FREE_FIELD_3 or UPDATED_FREE_FIELD_3
        defaultNomineeShouldBeFound("freeField3.in=" + DEFAULT_FREE_FIELD_3 + "," + UPDATED_FREE_FIELD_3);

        // Get all the nomineeList where freeField3 equals to UPDATED_FREE_FIELD_3
        defaultNomineeShouldNotBeFound("freeField3.in=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField3IsNullOrNotNull() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField3 is not null
        defaultNomineeShouldBeFound("freeField3.specified=true");

        // Get all the nomineeList where freeField3 is null
        defaultNomineeShouldNotBeFound("freeField3.specified=false");
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField3ContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField3 contains DEFAULT_FREE_FIELD_3
        defaultNomineeShouldBeFound("freeField3.contains=" + DEFAULT_FREE_FIELD_3);

        // Get all the nomineeList where freeField3 contains UPDATED_FREE_FIELD_3
        defaultNomineeShouldNotBeFound("freeField3.contains=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField3NotContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField3 does not contain DEFAULT_FREE_FIELD_3
        defaultNomineeShouldNotBeFound("freeField3.doesNotContain=" + DEFAULT_FREE_FIELD_3);

        // Get all the nomineeList where freeField3 does not contain UPDATED_FREE_FIELD_3
        defaultNomineeShouldBeFound("freeField3.doesNotContain=" + UPDATED_FREE_FIELD_3);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField4IsEqualToSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField4 equals to DEFAULT_FREE_FIELD_4
        defaultNomineeShouldBeFound("freeField4.equals=" + DEFAULT_FREE_FIELD_4);

        // Get all the nomineeList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultNomineeShouldNotBeFound("freeField4.equals=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField4IsInShouldWork() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField4 in DEFAULT_FREE_FIELD_4 or UPDATED_FREE_FIELD_4
        defaultNomineeShouldBeFound("freeField4.in=" + DEFAULT_FREE_FIELD_4 + "," + UPDATED_FREE_FIELD_4);

        // Get all the nomineeList where freeField4 equals to UPDATED_FREE_FIELD_4
        defaultNomineeShouldNotBeFound("freeField4.in=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField4IsNullOrNotNull() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField4 is not null
        defaultNomineeShouldBeFound("freeField4.specified=true");

        // Get all the nomineeList where freeField4 is null
        defaultNomineeShouldNotBeFound("freeField4.specified=false");
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField4ContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField4 contains DEFAULT_FREE_FIELD_4
        defaultNomineeShouldBeFound("freeField4.contains=" + DEFAULT_FREE_FIELD_4);

        // Get all the nomineeList where freeField4 contains UPDATED_FREE_FIELD_4
        defaultNomineeShouldNotBeFound("freeField4.contains=" + UPDATED_FREE_FIELD_4);
    }

    @Test
    @Transactional
    void getAllNomineesByFreeField4NotContainsSomething() throws Exception {
        // Initialize the database
        nomineeRepository.saveAndFlush(nominee);

        // Get all the nomineeList where freeField4 does not contain DEFAULT_FREE_FIELD_4
        defaultNomineeShouldNotBeFound("freeField4.doesNotContain=" + DEFAULT_FREE_FIELD_4);

        // Get all the nomineeList where freeField4 does not contain UPDATED_FREE_FIELD_4
        defaultNomineeShouldBeFound("freeField4.doesNotContain=" + UPDATED_FREE_FIELD_4);
    }
    ...
    void putExistingNominee() throws Exception {
        ...
        assertThat(testNominee.getIsActive()).isEqualTo(UPDATED_IS_ACTIVE);
        assertThat(testNominee.getIsDeleted()).isEqualTo(UPDATED_IS_DELETED);
        assertThat(testNominee.getFreeField1()).isEqualTo(UPDATED_FREE_FIELD_1);
        assertThat(testNominee.getFreeField2()).isEqualTo(UPDATED_FREE_FIELD_2);
        assertThat(testNominee.getFreeField3()).isEqualTo(UPDATED_FREE_FIELD_3);
        assertThat(testNominee.getFreeField4()).isEqualTo(UPDATED_FREE_FIELD_4);
    }
