...
describe('IncomeDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'income-details', component: IncomeDetailsComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.incomeDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to incomeDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getIncomeDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getIncomeDetailsIdentifier).toHaveBeenCalledWith(entity);
