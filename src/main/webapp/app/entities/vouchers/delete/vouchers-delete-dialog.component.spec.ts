...
import { VouchersDeleteDialogComponent } from './vouchers-delete-dialog.component';

describe('Vouchers Management Delete Component', () => {
  let comp: VouchersDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(VouchersDeleteDialogComponent, '')
      .compileComponents();
