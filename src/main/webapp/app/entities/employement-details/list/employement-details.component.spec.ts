...
describe('EmployementDetails Management Component', () => {
  let comp: EmployementDetailsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'employement-details', component: EmployementDetailsComponent }]),
      ...
      .overrideTemplate(EmployementDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employementDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employementDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployementDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployementDetailsIdentifier).toHaveBeenCalledWith(entity);
