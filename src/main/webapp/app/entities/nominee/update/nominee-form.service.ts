...
type NomineeFormDefaults = Pick<NewNominee, 'id' | 'nomineeDeclareDate' | 'lastModified' | 'createdOn' | 'isActive' | 'isDeleted'>;
...
type NomineeFormGroupContent = {
  ...
  nomineePercentage: FormControl<NomineeFormRawValue['nomineePercentage']>;
  ...
  isActive: FormControl<NomineeFormRawValue['isActive']>;
  isDeleted: FormControl<NomineeFormRawValue['isDeleted']>;
  freeField1: FormControl<NomineeFormRawValue['freeField1']>;
  freeField2: FormControl<NomineeFormRawValue['freeField2']>;
  freeField3: FormControl<NomineeFormRawValue['freeField3']>;
  freeField4: FormControl<NomineeFormRawValue['freeField4']>;
...
export class NomineeFormService {
  createNomineeFormGroup(nominee: NomineeFormGroupInput = { id: null }): NomineeFormGroup {
    ...
    return new FormGroup<NomineeFormGroupContent>({
      ...
      nomineePercentage: new FormControl(nomineeRawValue.nomineePercentage),
      ...
      isActive: new FormControl(nomineeRawValue.isActive),
      isDeleted: new FormControl(nomineeRawValue.isDeleted),
      freeField1: new FormControl(nomineeRawValue.freeField1),
      freeField2: new FormControl(nomineeRawValue.freeField2),
      freeField3: new FormControl(nomineeRawValue.freeField3),
      freeField4: new FormControl(nomineeRawValue.freeField4),
