...
type RestOf<T extends IOrganisation | NewOrganisation> = Omit<T, 'createdOn' | 'lastModified'> & {
...
export class OrganisationService {
  ...
  protected convertDateFromClient<T extends IOrganisation | NewOrganisation | PartialUpdateOrganisation>(organisation: T): RestOf<T> {
    return {
      ...organisation,
      createdOn: organisation.createdOn?.toJSON() ?? null,
      lastModified: organisation.lastModified?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restOrganisation: RestOrganisation): IOrganisation {
    return {
      ...restOrganisation,
      createdOn: restOrganisation.createdOn ? dayjs(restOrganisation.createdOn) : undefined,
      lastModified: restOrganisation.lastModified ? dayjs(restOrganisation.lastModified) : undefined,
    };
  }
