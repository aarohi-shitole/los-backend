...
export class LoanAccountComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILoanAccount): number => this.loanAccountService.getLoanAccountIdentifier(item);
  ...
  delete(loanAccount: ILoanAccount): void {
    const modalRef = this.modalService.open(LoanAccountDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.loanAccounts = dataFromBody;
  }
  ...
  protected queryBackend(
    ...
    return this.loanAccountService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
