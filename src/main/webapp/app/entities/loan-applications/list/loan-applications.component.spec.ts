...
describe('LoanApplications Management Component', () => {
  let comp: LoanApplicationsComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'loan-applications', component: LoanApplicationsComponent }]),
      ...
      .overrideTemplate(LoanApplicationsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.loanApplications?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to loanApplicationsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getLoanApplicationsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getLoanApplicationsIdentifier).toHaveBeenCalledWith(entity);
