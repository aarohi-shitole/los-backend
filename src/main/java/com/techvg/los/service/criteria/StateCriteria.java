...
/**
 * Criteria class for the {@link com.techvg.los.domain.State} entity. This class is used
 * in {@link com.techvg.los.web.rest.StateResource} to receive all the possible filtering options from
...
public class StateCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, stateName, isDeleted, lgdCode, lastModified, lastModifiedBy, distinct);
    }
