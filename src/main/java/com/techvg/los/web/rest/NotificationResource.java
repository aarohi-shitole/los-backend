...
import com.techvg.los.service.NotificationQueryService;
import com.techvg.los.service.NotificationService;
...
/**
 * REST controller for managing {@link com.techvg.los.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
public class NotificationResource {
    ...
    public ResponseEntity<Count> countNotifications(NotificationCriteria criteria) {
        log.debug("REST request to count Notifications by criteria: {}", criteria);
        Count notificationCount = new Count();
        notificationCount.count = notificationQueryService.countByCriteria(criteria);
