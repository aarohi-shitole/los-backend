...
import com.techvg.los.service.ParameterLookupQueryService;
import com.techvg.los.service.ParameterLookupService;
...
/**
 * REST controller for managing {@link com.techvg.los.domain.ParameterLookup}.
 */
@RestController
@RequestMapping("/api")
public class ParameterLookupResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','PARAMETER_EDIT')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','PARAMETER_VIEW','LOAN_APPL_VIEW')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','PARAMETER_VIEW')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','PARAMETER_VIEW','PARAMETER_EDIT')")
