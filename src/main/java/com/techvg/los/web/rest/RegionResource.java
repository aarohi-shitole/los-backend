...
import com.techvg.los.service.RegionQueryService;
import com.techvg.los.service.RegionService;
...
/**
 * REST controller for managing {@link com.techvg.los.domain.Region}.
 */
@RestController
@RequestMapping("/api")
public class RegionResource {
     ...
     */
    @PostMapping("/regions")
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','REGION_EDIT')")
     ...
     */
    @GetMapping("/regions")
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','REGION_VIEW','LOAN_APPL_VIEW')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'REGION_VIEW','LOAN_APPL_VIEW')")
    public ResponseEntity<Count> countRegions(RegionCriteria criteria) {
        log.debug("REST request to count Regions by criteria: {}", criteria);
        Count regionsCount = new Count();
        regionsCount.count = regionQueryService.countByCriteria(criteria);
        return ResponseEntity.ok().body(regionsCount);
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'REGION_VIEW','REGION_EDIT',LOAN_APPL_EDIT)")
