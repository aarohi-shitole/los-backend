...
import com.techvg.los.service.DistrictQueryService;
import com.techvg.los.service.DistrictService;
...
/**
 * REST controller for managing {@link com.techvg.los.domain.District}.
 */
@RestController
@RequestMapping("/api")
public class DistrictResource {
     ...
     *         body the new districtDTO, or with status {@code 400 (Bad Request)} if
     *         the district has already an ID.
     ...
     *         the updated districtDTO, or with status {@code 400 (Bad Request)} if
     *         the districtDTO is not valid, or with status
     *         {@code 500 (Internal Server Error)} if the districtDTO couldn't be
     *         updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    ...
    /**
     * {@code PATCH  /districts/:id} : Partial updates given fields of an existing
     * district, field will ignore if it is null
     *
     * @param id          the id of the districtDTO to save.
     * @param districtDTO the districtDTO to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the updated districtDTO, or with status {@code 400 (Bad Request)} if
     *         the districtDTO is not valid, or with status {@code 404 (Not Found)}
     *         if the districtDTO is not found, or with status
     *         {@code 500 (Internal Server Error)} if the districtDTO couldn't be
     *         updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body
     *         the districtDTO, or with status {@code 404 (Not Found)}.
     */
