...
import com.techvg.los.repository.SecurityRoleRepository;
import com.techvg.los.service.SecurityRoleQueryService;
import com.techvg.los.service.SecurityRoleService;
import com.techvg.los.service.criteria.SecurityRoleCriteria;
...
/**
 * REST controller for managing {@link com.techvg.los.domain.SecurityRole}.
 */
@RestController
@RequestMapping("/api")
public class SecurityRoleResource {
    ...
    public ResponseEntity<List<SecurityRoleDTO>> getAllSecurityRoles(
        ...
        //-------------------------------------------------------------------------------
        //Remove Super Admin role from list of role list
        StringFilter stringFilter = new StringFilter();
        stringFilter.setDoesNotContain("SUPER_ADMIN");
        criteria.setRoleName(stringFilter);
