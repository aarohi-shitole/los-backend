...
/**
 * REST controller for managing {@link com.techvg.los.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','LOAN_PRODUCT_EDIT')")
     ...
     */
    @GetMapping("/products")
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','LOAN_PRODUCT_VIEW','LOAN_APPL_VIEW')")
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN','LOAN_PRODUCT_VIEW')")
    public ResponseEntity<Count> countProducts(ProductCriteria criteria) {
        log.debug("REST request to count Products by criteria: {}", criteria);
        Count productCount = new Count();
        productCount.count = productQueryService.countByCriteria(criteria);
        return ResponseEntity.ok().body(productCount);
    }
    ...
    @PreAuthorize("hasAnyAuthority('ROLE_ADMIN', 'LOAN_PRODUCT_VIEW','LOAN_PRODUCT_EDIT')")
