...
public class SecurityUser implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "address", "region" }, allowSetters = true)
    ...
    public SecurityUser imageUrlContentType(String imageUrlContentType) {
    ...
    public SecurityUser isActivated(Boolean isActivated) {
    ...
    public SecurityUser employeeId() {
    ...
    public SecurityUser freeField1(String freeField1) {
    ...
    public SecurityUser freeField2(String freeField2) {
    ...
    public SecurityUser freeField3(String freeField3) {
    ...
    public SecurityUser freeField4(String freeField4) {
    ...
    public SecurityUser branch(Branch branch) {
    ...
    public SecurityUser organisation(Organisation organisation) {
