...
public class SecurityConfiguration {
    ...
    private static final String[] AUTH_WHITELIST = { "/api/image/", "/api/image/*", "/api/uploads/files/*" };
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.headers().contentSecurityPolicy(jHipsterProperties.getSecurity().getContentSecurityPolicy()).and()
		...
		.antMatchers("/api/account/reset-password/finish").permitAll().antMatchers("/api/admin/**")
		...
		.antMatchers("/management/**").hasAuthority(AuthoritiesConstants.ADMIN).and().httpBasic().and()
